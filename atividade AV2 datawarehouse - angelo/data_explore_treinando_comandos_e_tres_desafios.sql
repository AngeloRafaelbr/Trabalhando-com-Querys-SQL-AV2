...
#Qual o período do ano em que o restaurante tem maior movimento *DESAFIO 01*
-- ???
...
# Qual o cliente que mais fez pedidos por ano *DESAFIO 02*
-- ??
-- ########### RESPOSTA ###########
#pegar como base a utilização anterior deste codigo
...
# Qual o cliente que mais gastou em todos os anos *DESAFIO 03*
-- ??
